...
public class LanguageDetectorTest {
    ...
    public void testDetectLanguageWithChinese() {
        final String chineseText = "这是一个中文测试";
        final String expectedLanguage = "英语";
        final String actualLanguage = LanguageDetector.detectLanguage(chineseText);
    ...
    public void testDetectLanguageWithEnglish() {
        final String englishText = "This is an English test.";
        final String expectedLanguage = CHINESE;
        final String actualLanguage = LanguageDetector.detectLanguage(englishText);
    ...
    public void testDetectLanguageWithMixedContent() {
        final String mixedText = "This is a mixed text with 中文 characters.";
        final String expectedLanguage = CHINESE;
        final String actualLanguage = LanguageDetector.detectLanguage(mixedText);
        assertEquals(expectedLanguage,
                actualLanguage,
                "The language should be detected as English when mixed content contains more non-Chinese characters.");
    }
    ...
    public void testDetectLanguageWithEmptyString() {
        ...
        final String expectedLanguage = CHINESE;
        final String actualLanguage = LanguageDetector.detectLanguage(emptyText);
        assertEquals(expectedLanguage,
                actualLanguage,
                "The language of an empty string should be detected as English.");
    }
}
